...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Mouse Drag", "Glisser (souris)"),
        ("Pan Canvas", "Défiler le canevas"),
        ("Zoom", "Zoom"),
        ("Nothing", "Rien"),
        ("Copy", "Copier"),
        ("Select All", "Tout sélectionner"),
        ...
        // Gesture inputs
        ("One-Finger Tap", "Appui à un doigt"),
        ("One-Long Tap", "Appui long"),
        ("One-Finger Move", "Glissement à un doigt"),
        ("Double Tap & Move", "Double appui et glisser"),
        ("Three-Finger vertically", "Trois doigts verticalement"),
        ("Two-Finger Move", "Glissement à deux doigts"),
        ("Pinch to Zoom", "Pincer pour zoomer"),
        ("Two-Finger Tap", "Appui à deux doigts"),
        ("Double Tap", "Double appui"),
        // UI strings
        ("Reset to default", "Réinitialiser par défaut"),
        ("Hide local cursor", "Masquer le curseur local"),
        ("Hide distant cursor", "Masquer le curseur distant"),
        ("Theme Customization", "Personnalisation du thème"),
        ("Accent Color", "Couleur d'accent"),
        ("Sober Theme", "Thème sobre"),
        ("Translucent toolbar with blur effect", "Barre d'outils translucide avec effet de flou"),
        ("Preview", "Aperçu"),
        ("Default Blue", "Bleu par défaut"),
        ("Teal", "Sarcelle"),
        ("Purple", "Violet"),
        ("Orange", "Orange"),
        ("Red", "Rouge"),
        ...
        ("Gesture Settings", "Paramètres gestuels"),
        ("Show virtual mouse", "Afficher la souris virtuelle"),
        ("Show virtual joystick", "Afficher le joystick virtuel"),
        ("Virtual mouse size", "Taille de la souris virtuelle"),
        ("Small", "Petit"),
