...
const String kOptionAutoVirtualDisplay = 'auto-virtual-display';
...
const String kOptionHideLocalCursorMouse = "hide-local-cursor-mouse";
const String kOptionHideLocalCursorTouch = "hide-local-cursor-touch";
const String kOptionHideRemoteCursorMouse = "hide-remote-cursor-mouse";
const String kOptionHideRemoteCursorTouch = "hide-remote-cursor-touch";
